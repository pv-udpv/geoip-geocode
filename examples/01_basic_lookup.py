...
def example_basic_lookup():
    ...
    config = ProviderConfig(
        name="geoip2",
        enabled=True,
        database_path="./data/databases/GeoLite2-City.mmdb",  # Update with your path
    )
...
def example_custom_geodata():
    ...
    print(
        f"  Full Address: {geo_data.city}, {geo_data.subdivision}, {geo_data.country_name}"
    )
...
def example_error_handling():
    ...
    config = ProviderConfig(
        name="geoip2", database_path="./data/databases/GeoLite2-City.mmdb"
    )
